                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div className="bg-white px-4 pb-4 pt-10 sm:p-6 sm:pb-4">
                                ...
                                {useInputBox && (
                                    <div className="flex flex-col gap-1 mt-2">
                                        ...
                                        <input
                                            type="text"
                                            className="p-2 border border-y-sky-300"
                                            style={{
                                                outline: 'none',
                                                borderRadius: '4px',
                                                color: 'black',
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button
                                    type="button"
                                    className="mt-3 inline-flex w-full justify-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:scale-95 sm:ml-3 sm:w-auto"
                                    onClick={(e) => {
                                        handleSubmit(value);
                                    }}
                                >
